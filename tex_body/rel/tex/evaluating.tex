...
earlier. A direct display of transparency is not straightforward, particularly given that some of 
these proposals involve modifying the behaviour of models or lack inherent interpretability 
themselves. Conversely, post-hoc interpretations are often found in the input space. As a result, 
...
recognition}), randomly perturbing the input guided by saliency information descibed by the 
...
\emph{\gls{ad}}  quantifies how much predictive power, measured as class probability, 
...
\input{tex_body/rel/tex/ins_del.tex}
%--------------------------------------------------------------------------------------------------
...
\emph{\gls{ep}\autocite{wang2020score}} is equivalent to precision~\eq{prec}.\\
