...
%such as Support Vector Machines, Random Forests, and k-Nearest Neighbors, marked a pivotal shift 
...
More importantly, its robustness towards scale and rotation has led to widespread adopted in real 
