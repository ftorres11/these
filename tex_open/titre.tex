...
\begin{flushleft}
    ...
    \titl{\Large le \textit{jour} \textit{mois} 2024 par}\\
\end{flushleft}
\vspace{2em}
\begin{center}
...
\begin{center}
	...
	\begin{minipage}[t]{.52\linewidth}
        ...
        \begin{tabular}{p{12em} p{9.5em}}
        	...
        	Centrale Marseille, Aix Marseille Univ, CNRS, LIS. \\
        	Yannis AVRITHIS & Co-directeur de thèse \\
        	Institute for Advanced Research on Artificial Intelligence (IARAI) \\
...
\begin{center} %% logos partenaire
	\begin{minipage}[c]{.5\linewidth}
       \centering\includegraphics[height=4em]{logo_amu_excellence} 
	\end{minipage}\hfill
	\begin{minipage}[c]{.5\linewidth}
