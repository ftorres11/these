...
%    }
    \vspace{3pt}
    \caption{}
    %Raw attention maps obtained from our \Ours on images of the MIT 67 Scenes dataset \cite{quattoni2009recognizing} on classes that do not exist in ImageNet. The network sees them at inference for the first time.
